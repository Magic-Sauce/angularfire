(function (global, factory) {
    ...
    AngularFireAuthGuard.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: AngularFireAuthGuard, deps: [{ token: i1__namespace.Router }, { token: i2__namespace.AngularFireAuth }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    AngularFireAuthGuard.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: AngularFireAuthGuard, providedIn: 'any' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: AngularFireAuthGuard, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'any'
                    }]
    ...
    AngularFireAuthGuardModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: AngularFireAuthGuardModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    AngularFireAuthGuardModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: AngularFireAuthGuardModule });
    AngularFireAuthGuardModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: AngularFireAuthGuardModule, providers: [AngularFireAuthGuard] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0__namespace, type: AngularFireAuthGuardModule, decorators: [{
                type: i0.NgModule,
                args: [{
